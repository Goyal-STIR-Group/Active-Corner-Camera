...
dirpath = '/Users/sheilawerth/Dropbox/Lab/ActiveCornerCamera/SheilaHooverShare/Experimental Results/paperCode/Examples/facetAngularSweep/';
...
load('data_angularSweep.mat')
     
    
for posNum =1:14 % loop through positions
    clc
    close all
