...
dirpath = '/Users/sheilawerth/Dropbox/Lab/ActiveCornerCamera/SheilaHooverShare/Experimental Results/paperCode/Examples/ambientLight/';
...
load('data_031122_AmbientLight_EmptyRoom.mat')
load('data_ambientLight.mat')
     
% posNum = 1: object at 90 degrees into scene at range of 125cm    
for posNum =1 % loop through positions
