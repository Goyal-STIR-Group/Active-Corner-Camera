...
dirpath = '/Users/sheilawerth/Dropbox/Lab/ActiveCornerCamera/SheilaHooverShare/Experimental Results/paperCode/Examples/modelMismatch/';
...
load('data_031022_EmptyRoom.mat')
load('data_modelMismatch.mat')
     
    
% posNum = 1: White facet
% posNum = 2: Gray facet
% posNum = 3: Mannequin
% posNum = 4: Stairs
for posNum =1:4 % loop through positions
